...
def calculate_qs(*args, **kwargs):
    return _calculate_qs(*args, **kwargs)


def calculate_jatc(qs_score, form_accuracy, discomfort_response, rpe):
    """Combine QS, movement quality, discomfort stability, and load fit."""
