...
class SessionRecordForm(forms.ModelForm):
    class Meta:
        model = MemberSession
        fields = ['member_name', 'goal', 'discomfort_area', 'form_accuracy', 'qc_status', 'qc_score', 'posture_score', 'lifestyle_score', 'function_training_score', 'pain_response', 'rpe', 'memo']
        widgets = {
            ...
            'form_accuracy': forms.NumberInput(attrs={'class': 'form-control', 'min': '0', 'max': '10', 'step': '1'}),
